...
public class CartItemTest {	
	...
	@Test
	public void setCartItemProduct() {
		CartItem cartItem = new CartItem();
		Product product = new Product("0","android","test product","test manufacturer","test product name",19.99,"200");
		Assertions.assertNotNull(product);
		cartItem.setProduct(product);
	}
	
	@Test
	public void setCartItemCartWithProducts() {
	...
	@Test
	public void setCartItemPriceNotEqual0() {
		CartItem cartItem = new CartItem();
		Product product = new Product("0","android","test product 0","test manufacturer 0","test product 0 name",19.99,"200");
		Assertions.assertNotNull(product);
		cartItem.setProduct(product);
		cartItem.setPrice(product.getProductPrice());
		Assertions.assertEquals(19.99,cartItem.getPrice());
	}
	...
	public void cartPriceEqualsExpectedValue() {
		...
		cart.setCartItem(cartItems);
		Assertions.assertNotNull(cart.getCartItem());
		double totalOfProductPrices = cartItems.stream()
		...
		double totalOfCartItemPrices = cartItems.stream()
										.mapToDouble( cartItem -> cartItem
																	.getPrice() )
										.sum();
		Assertions.assertEquals(totalOfProductPrices,totalOfCartItemPrices);
	}
